...
import com.company.gamestoreinvoicing.viewModel.*;
...
public class GameStoreServiceLayerTest {
    ...
    public void setUp() throws Exception {
        ...
        service = new GameStoreServiceLayer(
                invoiceRepository, taxRepository, processingFeeRepository, catalogClient);
    }
    ...
    private void setUpCatalogClientMock(){
        ...
        doReturn(Optional.of(tShirt)).when(catalogClient).getSingleTShirt(54);
