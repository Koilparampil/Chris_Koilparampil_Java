...
public class GameStoreServiceLayer {
    ...
    public InvoiceViewModel createInvoice(InvoiceViewModel invoiceViewModel) {
        ...
        if (invoiceViewModel.getItemType().equals(CONSOLE_ITEM_TYPE)) {
            ...
            Optional<Console> returnVal = catalogClient.getSingleConsole(invoiceViewModel.getItemId());
            ...
            Game tempGame = null;
            Optional<Game> returnVal = catalogClient.getSingleGame(invoiceViewModel.getItemId());
            ...
            Optional<TShirt> returnVal = catalogClient.getSingleTShirt(invoiceViewModel.getItemId());
